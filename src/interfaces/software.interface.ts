...
export interface ICreateSoftware extends Record<string, SoftwareType> {
...
export interface ISellerSoftware {
  _id?: string | ObjectId;
...
export interface ISoftwareContext {
  Software: ISellerSoftware;
  seller: ISellerDocument;
  isSuccess?: boolean;
  isLoading?: boolean;
}

export interface ISoftwaresProps {
  type?: string;
  Software?: ISellerSoftware;
}

export interface ISoftwareCardItems {
  Software: ISellerSoftware;
  linkTarget: boolean;
...
export interface ISoftwareViewReviewsProps {
  showRatings: boolean;
...
export interface ISoftwareTopProps {
  Softwares: ISellerSoftware[];
  title?: string;
  subTitle?: string;
  category?: string;
  width: string;
