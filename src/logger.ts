...
export const winstonLogger = (elasticsarchNode: string, name: string, level:string): Logger => {
    const options = {
        console: {
            level,
        ...
        elasticsearch: {
            ...
            clientOpts: { node: elasticsarchNode, log: level, maxRetries: 2, requestTimeout: 10000, sniffOnStart: false },
        }
    };
